...
L0$pb:
	...
	jbe	LBB0_2
## BB#1:
	movss	-48(%ebp), %xmm0        ## xmm0 = mem[0],zero,zero,zero
	movd	%xmm0, %eax
	xorl	$2147483648, %eax       ## imm = 0x80000000
	movd	%eax, %xmm0
	movss	%xmm0, -76(%ebp)        ## 4-byte Spill
	jmp	LBB0_3
LBB0_2:
	movss	-48(%ebp), %xmm0        ## xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -76(%ebp)        ## 4-byte Spill
LBB0_3:
	movss	-76(%ebp), %xmm0        ## 4-byte Reload
                                        ## xmm0 = mem[0],zero,zero,zero
	movl	-72(%ebp), %eax         ## 4-byte Reload
	movss	LCPI0_0-L0$pb(%eax), %xmm1 ## xmm1 = mem[0],zero,zero,zero
	movl	$6, %ecx
	movl	$1, %edx
	movl	$103, %esi
	movl	$71, %edi
...
## BB#7:                                ##   in Loop: Header=BB0_4 Depth=1
	...
	calll	_strtof$UNIX2003
	fstps	-68(%ebp)
	movss	-68(%ebp), %xmm0        ## xmm0 = mem[0],zero,zero,zero
	ucomiss	-48(%ebp), %xmm0
	jne	LBB0_10
	jp	LBB0_10
LBB0_8:
