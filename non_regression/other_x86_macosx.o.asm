...
L00000011:
	...
	movl      12(%ebp), %eax
	movl      4(%eax), %eax
	movl      L_x$non_lazy_ptr-L00000011(%esi), %ecx
	movl      %ecx, -40(%ebp)
	movl      %eax, (%ecx)
	movl      %eax, (%esp)
	call      _strlen
L00000031:
	...
	call      _calloc
L00000044:
	movl      L_i$non_lazy_ptr-L00000011(%esi), %ecx
	movl      %ecx, -44(%ebp)
	movl      %eax, (%ecx)
	cmpl      $1, %ebx
	je        L0000095E
L00000058:
	movl      L__$non_lazy_ptr-L00000011(%esi), %eax
	movl      %eax, -24(%ebp)
	movl      L_Q$non_lazy_ptr-L00000011(%esi), %edx
	movl      %edx, -32(%ebp)
	movsd     LC000009A0-L00000011(%esi), %xmm0
	movsd     %xmm0, -64(%ebp)
	movsd     LC000009A8-L00000011(%esi), %xmm0
	movsd     %xmm0, -72(%ebp)
	movl      L_V$non_lazy_ptr-L00000011(%esi), %eax
	movl      %eax, -48(%ebp)
	leal      LC00001013-L00000011(%esi), %eax
	movl      %eax, -76(%ebp)
	movl      L_s$non_lazy_ptr-L00000011(%esi), %eax
	movl      %eax, -36(%ebp)
	leal      _z-L00000011(%esi), %eax
	movl      %eax, -52(%ebp)
	movsd     LC00000990-L00000011(%esi), %xmm0
	movsd     %xmm0, -88(%ebp)
	movsd     LC00000998-L00000011(%esi), %xmm0
	movsd     %xmm0, -96(%ebp)
	movaps    LC00000970-L00000011(%esi), %xmm0
	movaps    %xmm0, -200(%ebp)
	movdqa    LC00000980-L00000011(%esi), %xmm0
	movdqa    %xmm0, -216(%ebp)
	movl      L_X$non_lazy_ptr-L00000011(%esi), %eax
	movl      %eax, -28(%ebp)
	leal      LC00001020-L00000011(%esi), %eax
	movl      %eax, -56(%ebp)
	jmp       L00000140
L000000F4:
	movsd     _b-L00000011(%esi), %xmm0
	mulsd     -64(%ebp), %xmm0
	addsd     -72(%ebp), %xmm0
	cvttsd2si %xmm0, %eax
	movl      %esi, %ebx
...
L000001B4:
	movl      -20(%ebp), %esi
	movl      L_B$non_lazy_ptr-L00000011(%esi), %eax
	movsd     (%eax), %xmm0
	movl      L_k$non_lazy_ptr-L00000011(%esi), %eax
	addsd     (%eax), %xmm0
	movsd     %xmm0, (%eax)
	cvttsd2si %xmm0, %eax
	movl      L_o$non_lazy_ptr-L00000011(%esi), %ecx
	movsd     (%ecx), %xmm0
	movl      L_l$non_lazy_ptr-L00000011(%esi), %ecx
	addsd     (%ecx), %xmm0
	movsd     %xmm0, (%ecx)
	addsd     _b-L00000011(%esi), %xmm0
	cvttsd2si %xmm0, %ecx
	leal      (%ecx,%ecx,4), %ecx
	sall      $7, %ecx
	movl      %edx, %edi
...
L00000300:
	addsd     -88(%ebp), %xmm0
	movl      -20(%ebp), %esi
	movl      L_R$non_lazy_ptr-L00000011(%esi), %ecx
	xorps     %xmm1, %xmm1
	cvtsi2sd  8(%ecx), %xmm1
	mulsd     %xmm0, %xmm1
	movl      L_T$non_lazy_ptr-L00000011(%esi), %edx
	cvtsi2sd  8(%edx), %xmm2
	addsd     %xmm1, %xmm2
	mulsd     %xmm0, %xmm2
	movl      L_O$non_lazy_ptr-L00000011(%esi), %edi
	xorps     %xmm1, %xmm1
	cvtsi2sd  8(%edi), %xmm1
	addsd     %xmm2, %xmm1
	mulsd     %xmm0, %xmm1
	movl      L_L$non_lazy_ptr-L00000011(%esi), %eax
	xorps     %xmm2, %xmm2
	cvtsi2sd  8(%eax), %xmm2
	addsd     %xmm1, %xmm2
	addsd     %xmm2, %xmm2
	...
	addsd     %xmm1, %xmm3
	addsd     %xmm3, %xmm3
	movl      L_l$non_lazy_ptr-L00000011(%esi), %ebx
	movsd     %xmm3, (%ebx)
	subsd     %xmm3, %xmm2
	movsd     -96(%ebp), %xmm7
	mulsd     %xmm7, %xmm2
	movl      L_o$non_lazy_ptr-L00000011(%esi), %ebx
	movsd     %xmm2, (%ebx)
	xorps     %xmm1, %xmm1
...
L00000451:
	...
	jl        L0000066A
L00000465:
	movl      L_T$non_lazy_ptr-L00000011(%edx), %eax
	movl      %eax, -132(%ebp)
	movdqu    16(%eax), %xmm2
	movl      L_O$non_lazy_ptr-L00000011(%edx), %ebx
	movl      %ebx, -176(%ebp)
	movdqu    16(%ebx), %xmm1
	movl      L_R$non_lazy_ptr-L00000011(%edx), %esi
	movl      %esi, -136(%ebp)
	movdqu    %xmm2, 16(%esi)
	movdqu    %xmm1, 16(%eax)
	movl      L_L$non_lazy_ptr-L00000011(%edx), %esi
	movl      %esi, -172(%ebp)
	movdqu    16(%esi), %xmm0
	movdqu    %xmm0, 16(%ebx)
	leal      1(%ecx), %edx
...
L00000678:
	incl      %ecx
	movl      %ecx, (%edi)
	movl      L_O$non_lazy_ptr-L00000011(%esi), %eax
	movdqu    16(%eax), %xmm0
	movl      L_L$non_lazy_ptr-L00000011(%esi), %ecx
	movdqu    16(%ecx), %xmm1
	movdqa    %xmm0, %xmm2
	paddd     %xmm2, %xmm2
	movdqu    %xmm2, (%ecx)
	movl      L_T$non_lazy_ptr-L00000011(%esi), %ecx
	movdqu    16(%ecx), %xmm2
	movdqu    %xmm1, 16(%eax)
	movdqa    %xmm1, %xmm3
	psubd     %xmm2, %xmm3
	movdqu    %xmm3, (%eax)
	movl      L_R$non_lazy_ptr-L00000011(%esi), %eax
	movdqu    %xmm2, 16(%eax)
	movdqu    %xmm0, 16(%ecx)
	paddd     %xmm2, %xmm2
	movdqa    %xmm0, %xmm4
