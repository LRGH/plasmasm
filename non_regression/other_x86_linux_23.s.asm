...
newnode:
	...
	movl      %edx, 20(%esp)
	movl      68(%esp), %ebp
	movl      s_node@GOTOFF+4(%ebx), %esi
	movl      s_node@GOTOFF+8(%ebx), %edx
	...
	testl     %edx, %edx
	jne       .L27
	movl      $1, s_node@GOTOFF+8(%ebx)
	movb      $1, %dl
.L25:
	imull     s_node@GOTOFF+12(%ebx), %edx
...
newopcall:
	...
	movl      s_node@GOTOFF+4(%ebx), %edi
	movl      %eax, 16(%esp)
	movl      s_node@GOTOFF+8(%ebx), %eax
	...
	movb      $1, %al
.L194:
	imull     s_node@GOTOFF+12(%ebx), %eax
	addl      16(%esp), %ebp
	movl      %edx, 28(%esp)
	movl      %ebp, 20(%esp)
	movl      %eax, %edi
...
pari_init_parser:
	...
	movl      $0, s_node@GOTOFF+4(%ebx)
	movl      $24, s_node@GOTOFF+12(%ebx)
	subl      %eax, %edi
...
.L274:
	...
	movzwl    (%ebp), %eax
	movsbl    yypgoto@GOTOFF-61(%ebx,%edx), %ecx
	leal      -61(%edx), %esi
	movswl    %ax, %edx
	addl      %ecx, %edx
	cmpl      $589, %edx
