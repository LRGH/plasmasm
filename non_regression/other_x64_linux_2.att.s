...
.L87:
	...
	leaq	-1(%rdi,%rax), %r15
	movq	(%rsp), %rax
	movsd	8+cache_model(%rip), %xmm1
	movsd	16+cache_model(%rip), %xmm3
	leaq	1(%rax), %r13
	cmpq	%rdx, %r13
	jbe	.L88
	testq	%r12, %r12
...
.L282:
	...
	testq	%rax, %rbx
	jne	.L284
	movabsq	$3170534137668829184, %rbp
	orq	%rbx, %rbp
.L279:
	movq	16(%rsp), %rax
	movq	24(%rsp), %rcx
...
.L284:
	...
	jmp	.L285
.L287:
	movabsq	$3170534137668829185, %rbp
	jmp	.L279
	.cfi_endproc
.LFE726:
...
.L319:
	...
	jbe	.L321
.L297:
	movabsq	$144115188075855875, %rax
	movq	%r13, (%r15)
	movq	%r12, -8(%rbx)
	movq	%rax, -24(%rbx)
	movabsq	$4611686018427387907, %rax
	movq	%r13, %rdi
	movq	%rax, -16(%rbx)
	jmp	.L298
	.p2align 4,,10
...
.L323:
	movq	32(%rsp), %rax
	movq	%rax, 0(%rbp)
	movabsq	$2449958197289549828, %rax
	movq	%rax, -32(%r15)
	movq	0(%rbp), %r13
	movq	%r13, %rax
	subq	(%rdx), %rax
...
.L327:
	...
	movq	24(%rsp), %r8
.L328:
	movabsq	$3170534137668829184, %rsi
	movq	%rbx, 0(%rbp)
	movq	bot@GOTPCREL(%rip), %rdx
	orq	%r12, %rsi
	movq	%rsi, (%rbx)
...
.L459:
	...
	leaq	1(%r14), %r15
	movabsq	$-72057594037927936, %rax
	movabsq	$2449958197289549824, %rbx
	movq	%r15, %r13
	orq	%r15, %rbx
	leaq	0(,%r15,8), %r12
	andq	%rax, %r13
...
.L384:
	...
	jmp	.L382
.L414:
	movabsq	$2449958197289549825, %rbx
	xorl	%r13d, %r13d
	movl	$8, %r12d
	movl	$1, %r15d
	jmp	.L374
...
.L411:
	.cfi_restore_state
	movl	$16, %r12d
	movabsq	$2449958197289549826, %rbx
	xorl	%r13d, %r13d
	movl	$2, %r15d
	jmp	.L364
.L456:
...
.L467:
	addq	$1, %rax
	movabsq	$-72057594037927936, %r15
	movabsq	$3170534137668829184, %r14
	leaq	0(,%rax,8), %rcx
	andq	%rax, %r15
	orq	%rax, %r14
.L463:
...
.L504:
	movl	$16, %ecx
	movabsq	$3170534137668829186, %r14
	xorl	%r15d, %r15d
	movl	$2, %eax
	jmp	.L463
.L492:
